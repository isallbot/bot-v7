...
const start = async (tobz = new Client()) => {
        console.log('------------------------------------------------')
        lolcatjs.fromString(color(figlet.textSync('BOT ISALL', { horizontalLayout: 'full' })))
        console.log('------------------------------------------------')
        lolcatjs.fromString('[DEV] ISALL')
            ...
            if(mtcState === false){
                ...
                if(groups.length > groupLimit){
                    ...
                    if(chat.groupMetadata.participants.length < memberLimit){
                        ...
                        if(!chat.isReadOnly) tobz.sendText(chat.id, 'Halo I,AM BOT ISALL, Ketik #help Untuk Melihat List Command Ku...')
                    }
                }
            }else{
